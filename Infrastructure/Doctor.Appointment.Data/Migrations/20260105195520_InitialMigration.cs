        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PracticeNumber = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "Guest user with limited access", "Guest" },
                    { 2L, "Patient user", "Patient" },
                    { 3L, "Doctor user", "Doctor" },
                    { 4L, "Administrator with full access", "Admin" }
                });
