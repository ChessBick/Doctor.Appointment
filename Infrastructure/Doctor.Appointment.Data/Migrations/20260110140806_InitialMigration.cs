        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PracticeNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "Administrator with full access", "Admin" },
                    { 2L, "Doctor user with medical access", "Doctor" },
                    { 3L, "Patient user with limited access", "Patient" }
                });
